...
<div class="container">
  <div>
    ...
    <input type="text" name="student_netID" id="student_netID" value="<?php echo $_GET['student_netID']; ?>"/>
  </div>
  <div>
    <label>Approx. Number of Meetings with Advisor (0, 1, 2, 3-5, etc.):</label>
    <input type="text" name="number_of_meetings" id="number_of_meetings" value="<?php echo $form->number_of_meetings; ?>" />
  </div>
  <br>
  <div>
    <label>Student Self Assessment:</label>
    <textarea name="student_self_assessment" rows="5" cols="60" id="student_self_assessment"><?php echo $form->student_comments ?></textarea>
  </div>
</div>
